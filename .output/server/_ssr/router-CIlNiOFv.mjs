    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.header,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center justify-between rounded-2xl md:rounded-full px-4 md:px-6 py-2.5 nav-glass transition-all duration-500 ${scrolled ? "neon-shadow scale-[0.99]" : ""}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/home", className: "flex items-center gap-2.5 group shrink-0", "aria-label": "Moonlight — início", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-0.5", "aria-label": "Principal", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: l.to,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "md:hidden text-foreground p-2 -mr-1", onClick: () => setOpen(true), "aria-label": "Abrir menu", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "size-5" }) })
          ] })
        ] }) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: open && /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, className: "fixed inset-0 z-[120] md:hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setOpen(false), className: "p-2", "aria-label": "Close", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "size-6" }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "mt-12 flex flex-col gap-6", "aria-label": "Mobile", children: links.map((l, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: { x: 40, opacity: 0 }, animate: { x: 0, opacity: 1 }, transition: { delay: 0.1 + i * 0.05 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: l.to,
                activeOptions: { exact: l.to === "/home" },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-4 gap-10 pt-12 border-t border-border/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/home", className: "font-display text-xl", children: [
            "Moonlight",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-3 text-sm text-muted-foreground max-w-xs", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "O futuro não espera." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.a,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground mb-4", children: "Navegar" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/servicos", className: "hover:text-primary transition-colors", children: "Serviços" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/produtos", className: "hover:text-primary transition-colors", children: "Produtos" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/case-studies", className: "hover:text-primary transition-colors", children: "Case Studies" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contacto", className: "hover:text-primary transition-colors", children: "Contacto" }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground mb-4", children: "Sede" }),
...
const appCss = "/assets/styles-DhJNtW_m.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-7xl font-bold text-foreground", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 text-xl font-semibold text-foreground", children: "Page not found" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "The page you're looking for doesn't exist or has been moved." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/home", className: "inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90", children: "Go home" }) })
  ] }) });
}
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-wrap justify-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/home", className: "inline-flex items-center justify-center rounded-md border border-input bg-background px-4 py-2 text-sm font-medium text-foreground hover:bg-accent", children: "Go home" })
    ] })
  ] }) });
}
...
const $$splitComponentImporter$5 = () => import("./servicos-BRl3A33U.mjs");
const Route$6 = createFileRoute("/servicos")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Software Development, BI & Marketing, IT Consulting, IoT/AR/VR e Suporte SLA — engenharia de excelência desde 1998."
    }, {
      property: "og:title",
      content: "Serviços — Moonlight"
    }, {
      property: "og:description",
      content: "Cinco disciplinas, uma filosofia."
    }, {
      property: "og:url",
      content: "https://www.moonlight.pt/servicos"
    }],
    links: [{
      rel: "canonical",
      href: "https://www.moonlight.pt/servicos"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./quem-somos-DbjJtK2Q.mjs");
const Route$5 = createFileRoute("/quem-somos")({
  head: () => ({
    meta: [{
      title: "Quem Somos — Moonlight · Desde 1998"
    }, {
      name: "description",
      content: "A história, missão e cultura da Moonlight — software house portuguesa fundada em 1998."
    }, {
      property: "og:title",
      content: "Quem Somos — Moonlight"
    }, {
      property: "og:description",
      content: "27 anos de engenharia de excelência em Portugal."
    }, {
      property: "og:url",
      content: "https://www.moonlight.pt/quem-somos"
    }],
    links: [{
      rel: "canonical",
      href: "https://www.moonlight.pt/quem-somos"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./produtos-DpfwGIEI.mjs");
const Route$4 = createFileRoute("/produtos")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Cinco produtos proprietários para sales, analytics, supply chain, AR/VR e commerce."
    }, {
      property: "og:title",
      content: "Produtos — Moonlight"
    }, {
      property: "og:description",
      content: "Um sistema orbital de tecnologia proprietária."
    }, {
      property: "og:url",
      content: "https://www.moonlight.pt/produtos"
    }],
    links: [{
      rel: "canonical",
      href: "https://www.moonlight.pt/produtos"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./home-B5eAR5Pc.mjs");
const Route$3 = createFileRoute("/home")({
  head: () => ({
    meta: [{
      title: "Moonlight · Building the Future"
    }, {
      name: "description",
      content: "Software house portuguesa desde 1998: Software Development, BI & Marketing, IT Consulting, IoT/AR/VR e Suporte SLA. Produto próprio B.Analytics."
    }, {
      property: "og:url",
      content: "https://www.moonlight.pt/home"
    }],
    links: [{
      rel: "canonical",
      href: "https://www.moonlight.pt/home"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./contacto--XUF8Jiy.mjs");
const Route$2 = createFileRoute("/contacto")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Fala com a Moonlight. Conta-nos o desafio e voltamos com arquitetura, prazos e orçamento em 24h úteis."
    }, {
      property: "og:title",
      content: "Contacto — Moonlight"
    }, {
      property: "og:description",
      content: "Vamos desenhar o teu próximo sistema."
    }, {
      property: "og:url",
      content: "https://www.moonlight.pt/contacto"
    }],
    links: [{
      rel: "canonical",
      href: "https://www.moonlight.pt/contacto"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./case-studies-bSL3rNHT.mjs");
const Route$1 = createFileRoute("/case-studies")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfólio de transformações digitais entregues pela Moonlight."
    }, {
      property: "og:title",
      content: "Case Studies — Moonlight"
    }, {
      property: "og:description",
      content: "450+ projetos. Engenharia que move ponteiros de negócio."
    }, {
      property: "og:url",
      content: "https://www.moonlight.pt/case-studies"
    }],
    links: [{
      rel: "canonical",
      href: "https://www.moonlight.pt/case-studies"
    }]
  }),
...
const QuemSomosRoute = Route$5.update({
  id: "/quem-somos",
  path: "/quem-somos",
  getParentRoute: () => Route$7
});
...
const CaseStudiesRoute = Route$1.update({
  id: "/case-studies",
  path: "/case-studies",
  getParentRoute: () => Route$7
});
