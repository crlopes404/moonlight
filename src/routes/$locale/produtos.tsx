...
export const Route = createFileRoute("/$locale/produtos")({
  head: () => localizedHead({ path: "produtos", title: m.meta_produtos_title(), description: m.meta_produtos_desc() }),
  component: Produtos,
});
...
const products = [
  {
    ...
    headline: m.prod1_headline,
    desc: m.prod1_desc,
    features: [m.prod1_f1, m.prod1_f2, m.prod1_f3, m.prod1_f4, m.prod1_f5],
  ...
  },
  {
    ...
    headline: m.prod2_headline,
    desc: m.prod2_desc,
    features: [m.prod2_f1, m.prod2_f2, m.prod2_f3, m.prod2_f4, m.prod2_f5],
  ...
  },
  {
    ...
    headline: m.prod3_headline,
    desc: m.prod3_desc,
    features: [m.prod3_f1, m.prod3_f2, m.prod3_f3, m.prod3_f4, m.prod3_f5],
  ...
  },
  {
    ...
    headline: m.prod4_headline,
    desc: m.prod4_desc,
    features: [m.prod4_f1, m.prod4_f2, m.prod4_f3, m.prod4_f4, m.prod4_f5],
  ...
  },
  {
    ...
    headline: m.prod5_headline,
    desc: m.prod5_desc,
    features: [m.prod5_f1, m.prod5_f2, m.prod5_f3, m.prod5_f4, m.prod5_f5],
    ...
    <>
      ...
      <section className="relative pt-40 pb-12 overflow-hidden">
        <div className="relative mx-auto max-w-7xl px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="font-mono text-xs uppercase tracking-[0.3em] text-primary">{m.prod_hero_eyebrow()}</motion.div>
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="mt-6 font-display text-[clamp(2.8rem,7vw,6rem)] leading-[0.95] tracking-tight max-w-5xl">
            {m.prod_hero_t1()} <span className="text-gradient">{m.prod_hero_accent()}</span>.
          </motion.h1>
        </div>
      </section>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="mt-6 grid grid-cols-3 gap-3">
                  {sel.metrics.map((metric) => (
                    <div key={metric.k} className="glass rounded-lg p-3 text-center">
                      <div className="font-display text-2xl text-gradient">{metric.v}</div>
                      <div className="mt-1 text-[10px] font-mono uppercase tracking-wider text-muted-foreground">{metric.k}</div>
                    </div>
                  ))}
                </div>
              </motion.div>
            ...
            >
              ...
              <div className="glass-elev rounded-3xl p-8">
                ...
                <button data-magnetic className="mt-6 inline-flex items-center gap-2 text-sm text-primary group">
                  {m.prod_demo()} <ArrowRight className="size-3.5 transition-transform group-hover:translate-x-1" />
                </button>
              </div>
            </motion.div>
          </AnimatePresence>
      ...
      <CTABanner eyebrow="demo" title={m.prod_cta_title()} cta={m.prod_cta_cta()} />
    </>
  );
}
